...
class FabTransform : Transition {
    ...
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
        ...
        try {
            ...
            require(
                !(!a.hasValue(R.styleable.FabTransform_fabColor) || !a.hasValue(R.styleable.FabTransform_fabIcon))
    ...
    override fun createAnimator(
        ...
        val (translationX: Int, translationY: Int) = if (customMode != 0) {
            ...
            Pair(
                startBounds.centerX() - endBounds.centerX(),
                startBounds.centerY() - endBounds.centerY()
            )
        }
        ...
        fabIcon.setBounds(
            iconLeft, iconTop, iconLeft + fabIcon.intrinsicWidth, iconTop + fabIcon.intrinsicHeight
        )
        ...
        if (view is ViewGroup) {
            ...
            for (i in view.childCount - 1 downTo 0) {
                ...
                val fade: Animator = ObjectAnimator.ofFloat(
                    child, View.ALPHA, if (fromFab) 1f else 0f
                )
                if (fromFab) {
                    child.alpha = 0f
                }
